...
module.exports = (toolbox) => {
  ...
  toolbox.domains.prepareDomainsMap = (domains, pwaHost) => {
    let domainsMap = {};
    domains.filter(({ url }) => url.startsWith(pwaHost)).forEach((domain) => {
  ...
  toolbox.domains.stripHost = (absolutePath, pwaHost) => {
